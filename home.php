...
<style>
	.postwrap p:empty, .postwrap h2:empty {
    display: none;
}
	.wp-caption {
...
.dimg .img img {
	...
	.cont .rightfour img,.cont .leftone img {
    max-width: 100% !important;
}
	.toprow .left, .toprow .right {
    width: 48% !important;
...
.bottomrow .left, .bottomrow .right {
    width: 48% !important;
    float: left !important;
    clear: none !important;
}
  ...
  margin-right:2% !important;
	...
	.post .cont h2, .post .cont h2 a {
    color: #00003c !important;
}
	.post .cont h2:hover, .post .cont h2 a:hover {
   ...
   <img src="https://goldiracompaniescompared.com/wp-content/uploads/2024/05/aplogo.jpg"  alt="Gold IRA Companies Bulletin">
    ...
    <div class="post"> <div class="postcontent">
      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<div class="posthead"><h1><?php the_title();?></h1></div>
		<div class="divflex">
...
?>
	...
	/********* Start Gold IRA Information - Editors Pick **********/
		?>	
		<style>
			.cont.three .leftone, .cont.three .middle, .cont.three .rightfour {
    width: 30%;
    float: left;
}
			.cont.three .leftone, .cont.three .middle  {
    width: 30%;
    float: left;
	margin-right:2%;			
}
...
<div class="cont">
	...
	<div class="goldnews">
		 <rssapp-wall id="tNh5ILadAW5TE6NM"></rssapp-wall><script src="https://widget.rss.app/v1/wall.js" type="text/javascript" async></script>
	</div>
...
<div class="cont">
	...
	<div class="goldnews">
		 <rssapp-wall id="t6u7BSvtgCysrvjq"></rssapp-wall><script src="https://widget.rss.app/v1/wall.js" type="text/javascript" async></script>
	</div>
...
<div class="cont">
	...
	<div class="goldnews">
		 <rssapp-wall id="tyQjY8W1meIGeWv8"></rssapp-wall><script src="https://widget.rss.app/v1/wall.js" type="text/javascript" async></script>
	</div>
...
<div class="cont">
	...
	<div class="goldnews">
	<rssapp-wall id="tH21wEaii5UVnEm7"></rssapp-wall><script src="https://widget.rss.app/v1/wall.js" type="text/javascript" async></script>
	</div>
